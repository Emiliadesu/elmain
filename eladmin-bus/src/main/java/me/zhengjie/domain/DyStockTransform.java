...
@Entity
@Data
@Table(name="bus_dy_stock_transform")
public class DyStockTransform implements Serializable {
    ...
    @Column(name = "transform_type",nullable = false)
    @NotNull
    @ApiModelProperty(value = "库存变动类型 1：良转次 2：次转良")
    ...
    @Transient
    private List<DyStockTransformDetail> itemList;
    ...
    public void copy(DyStockTransform source){
