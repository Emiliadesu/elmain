...
public interface CustomerInfoService {
    ...
    */
    ...
    List<CustomerInfoDto> queryAllCustom(CustomerInfoQueryCriteria criteria);

    CustomerInfo queryByName(String cusName);

    CustomerInfoDto queryById(Long customerId);

    List<CustomerInfo> queryCustomerShop(Long customerId);

    List<CustomerInfo> queryUserCusShop();

    List<CustomerInfo> queryCurrentUserCustomer();
}
