...
public interface CompanyInfoService {
    ...
    */
     ...
     */
    CompanyInfoDto findById(Long companyId);
    ...
    * @return CompanyInfoDto
    */
    CompanyInfoDto create(CompanyInfo resources);
    ...
    * @throws IOException /
    */
    void download(List<CompanyInfoDto> all, HttpServletResponse response) throws IOException;
}